...
# List of keywords that indicate a person in crisis
...
# Response shown when crisis is detected - includes Indian helpline numbers
...
def safety_check(message):
    ...
    # If yes, return crisis response with helpline numbers
    # If no, return safe (no crisis)
